...
public class TelegramUserManager {
    ...
    public MessageBody createMessageBody(TelegramBot bot, Update update, String fileUrl) {
        ...
        messageBody.setTelegramBot(bot);

        return messageBody;
    }

    /*
    public void handleNewGroupUsers(List<User> newUsers, TelegramBot bot) {
